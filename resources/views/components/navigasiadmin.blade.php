<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
    ...
    <div class="collapse navbar-collapse w-auto custom-scrollbar" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('admin.beranda') ? 'active' : '' }}"
                    ...
                    <div
                        ...
                        <img src="{{ asset('assets/foto/dashboard.png') }}" alt="Dashboard" width="50"
                            height="50">
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('admin.datadosen*') ? 'active' : '' }}"
                    href="{{ route('admin.datadosen.index') }}">
                    <div
                        class="bg-gradient-info icon-shape shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <img src="{{ asset('assets/foto/dosenaktif.png') }}" alt="Data Dosen" width="50"
                            height="50">
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('admin.dataprodi*') ? 'active' : '' }}"
                    href="{{ route('admin.dataprodi.index') }}">
                    <div
                        class="bg-gradient-info icon-shape shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('admin.datajabatan*') ? 'active' : '' }}"
                    href="{{ route('admin.datajabatan.index') }}">
                    <div
                        class="bg-gradient-info icon-shape shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <img src="{{ asset('assets/foto/jabatan.png') }}" alt="Data Jabatan" width="50"
                            height="50">
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('admin.dataperiode*') ? 'active' : '' }}"
                    href="{{ route('admin.dataperiode.index') }}">
                    <div
                        class="bg-gradient-info icon-shape shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <img src="{{ asset('assets/foto/periode.png') }}" alt="Data Periode" width="50"
                            height="50">
                    </div>
        ...
        <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
            ...
            <div class="card-body text-start p-3 w-100">
                <div
                    ...
                    <img src="{{ asset('assets/foto/LogoWA.png') }}" alt="Logo WhatsApp" class="img-fluid"
                ...
                <div class="docs-info">
                    ...
                    <a href="https://www.creative-tim.com/learning-lab/bootstrap/license/soft-ui-dashboard"
                        target="_blank" class="btn btn-white btn-sm w-100 mb-0 bg-gradient-info">WA Super Admin</a>
                </div>
            </div>
        </div>
...
<style>
    ...
    .custom-scrollbar {
        ...
        overflow-y: hidden;
        /* Sembunyikan scrollbar saat tidak di-hover */
